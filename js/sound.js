// sound.js — lightweight WebAudio-based sound effects
export default class Sound{
  ...
  _beep(freq=440, length=0.08, type='sine', when=0){
    ...
    o.stop(this.ctx.currentTime + when + length + 0.02);
  }

  playStart(){
    this._beep(880, 0.06,'sawtooth');
    this._beep(660, 0.08,'sine',0.02);
  }

  playTick(){
    this._beep(1200, 0.035,'square');
  }

  playStop(){
    this._beep(520, 0.08,'sine');
  }

  playWin(){
    // simple arpeggio
    let t = 0;
    [880,1100,1320].forEach((f,i)=>{ this._beep(f, 0.12, 'sine', t); t += 0.12; });
  }
}
